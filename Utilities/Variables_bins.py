...
arrow_places = {'nslice':[0.5,3e5,0.6,3e5],
                ...
                'flash_time':[[6.55,1.98e4,8,1.98e4],[16.5,1.98e4,15,1.98e4]],
                'nu_flashmatch_score':[15,2.05e4,13,2.05e4],
...
arrow_places_r3 = {'nslice':[0.5,3e5,0.6,3e5],
                   'n_pfps':[6.52,2.3e5,6.0,2.3e5],
                   'flash_time':[[6.55,1.98e4,8,1.98e4],[16.5,1.98e4,15,1.98e4]],
                   'nu_flashmatch_score':[15, 31500.0, 13, 31500.0],
                   'NeutrinoEnergy2':[500, 2e4, 440, 2e4],
                   # 'max_x':[253],
                   # 'min_x':[9],
                   # 'max_y':[112],
                   # 'min_y':[-112],
                   ...
                   # 'min_z':[14],
                   # 'trk_score_v':[0.97],
                   'contained_fraction':[0.9, 600000.0, 0.95, 600000.0]}