...
variable_names_dict = {'nslice':"Neutrino slice",
                       ...
                       'shr_pz_v':"Shower z-momentum [GeV]",
                       'trk_theta_v':"Track theta [radians]",
                       'trk_phi_v':"Track phi [radians]",
                       'trk_energy_hits_tot':"Total track hits",
                       'trk_dir_z_v':"Track z-direction fraction",
                       'SliceCaloEnergy2':"Calorimatric energy in slice [GeV]"}
